...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IDirect3D11CaptureFramePool)->TryGetNextFrame(&value));
        return Windows::Graphics::Capture::Direct3D11CaptureFrame{ value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IDirect3D11CaptureFramePool)->CreateCaptureSession(*(void**)(&item), &value));
        return Windows::Graphics::Capture::GraphicsCaptureSession{ value, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCapturePicker)->PickSingleItemAsync(&result));
        return Windows::Foundation::IAsyncOperation<Windows::Graphics::Capture::GraphicsCaptureItem>{ result, take_ownership_from_abi };
    }
    ...
    {
        bool value;
        check_hresult(WINRT_IMPL_SHIM(Windows::Graphics::Capture::IGraphicsCaptureSessionStatics)->IsSupported(&value));
        return value;
    }
    template <typename D>
    ...
    struct produce<D, Windows::Graphics::Capture::IDirect3D11CaptureFramePool> : produce_base<D, Windows::Graphics::Capture::IDirect3D11CaptureFramePool>
    {
        ...
        int32_t __stdcall TryGetNextFrame(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall CreateCaptureSession(void* item, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall PickSingleItemAsync(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
