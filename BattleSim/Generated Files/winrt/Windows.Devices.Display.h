...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Devices_Display_IDisplayMonitor<D>::GetDescriptor(Windows::Devices::Display::DisplayMonitorDescriptorKind const& descriptorKind) const
    {
        ...
        uint8_t* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Display::IDisplayMonitor)->GetDescriptor(static_cast<int32_t>(descriptorKind), &value_impl_size, &value));
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::Display::IDisplayMonitorStatics)->GetDeviceSelector(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    ...
    struct produce<D, Windows::Devices::Display::IDisplayMonitor> : produce_base<D, Windows::Devices::Display::IDisplayMonitor>
    {
        ...
        int32_t __stdcall GetDescriptor(int32_t descriptorKind, uint32_t* __valueSize, uint8_t** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
