...
namespace winrt::impl
{
    ...
    {
        void* content{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::DataTransfer::IClipboardStatics)->GetContent(&content));
        return Windows::ApplicationModel::DataTransfer::DataPackageView{ content, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_ApplicationModel_DataTransfer_IClipboardStatics<D>::ContentChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const
    {
        winrt::event_token token;
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::DataTransfer::IClipboardStatics)->add_ContentChanged(*(void**)(&changeHandler), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_ApplicationModel_DataTransfer_IClipboardStatics<D>::ContentChanged_revoker consume_Windows_ApplicationModel_DataTransfer_IClipboardStatics<D>::ContentChanged(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const
    {
        return impl::make_event_revoker<D, ContentChanged_revoker>(this, ContentChanged(changeHandler));
    }
    ...
    {
        int32_t __stdcall GetContent(void** content) noexcept final try
        {
            clear_abi(content);
        ...
        int32_t __stdcall add_ContentChanged(void* changeHandler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().ContentChanged(*reinterpret_cast<Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const*>(&changeHandler)));
            return 0;
        }
        catch (...) { return to_hresult(); }
...
namespace winrt::Windows::ApplicationModel::DataTransfer
{
    ...
    inline auto Clipboard::ContentChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler)
    {
        return impl::call_factory<Clipboard, Windows::ApplicationModel::DataTransfer::IClipboardStatics>([&](auto&& f) { return f.ContentChanged(changeHandler); });
    }
    inline Clipboard::ContentChanged_revoker Clipboard::ContentChanged(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler)
    {
        auto f = get_activation_factory<Clipboard, Windows::ApplicationModel::DataTransfer::IClipboardStatics>();
        return { f, f.ContentChanged(changeHandler) };
    }
