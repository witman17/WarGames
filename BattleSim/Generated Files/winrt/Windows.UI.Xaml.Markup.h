...
namespace winrt::impl
{
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IComponentConnector2)->GetBindingConnector(connectionId, *(void**)(&target), &returnValue));
        return Windows::UI::Xaml::Markup::IComponentConnector{ returnValue, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IMarkupExtensionFactory<D>::CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IMarkupExtensionFactory)->CreateInstance(*(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Markup::MarkupExtension{ instance, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IMarkupExtensionOverrides<D>::ProvideValue() const
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IMarkupExtensionOverrides)->ProvideValue(&returnValue));
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IXamlBinaryWriterStatics<D>::Write(param::vector<Windows::Storage::Streams::IRandomAccessStream> const& inputStreams, param::vector<Windows::Storage::Streams::IRandomAccessStream> const& outputStreams, Windows::UI::Xaml::Markup::IXamlMetadataProvider const& xamlMetadataProvider) const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlBinaryWriterStatics)->Write(*(void**)(&inputStreams), *(void**)(&outputStreams), *(void**)(&xamlMetadataProvider), put_abi(returnValue)));
        return returnValue;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlBindingHelperStatics)->GetDataTemplateComponent(*(void**)(&element), &value));
        return Windows::UI::Xaml::Markup::IDataTemplateComponent{ value, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlBindingHelperStatics)->ConvertValue(impl::bind_in(type), *(void**)(&value), &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlMember)->GetValue(*(void**)(&instance), &value));
    ...
    {
        void* xamlType{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlMetadataProvider)->GetXamlType(impl::bind_in(type), &xamlType));
        return Windows::UI::Xaml::Markup::IXamlType{ xamlType, take_ownership_from_abi };
    }
    ...
    {
        void* xamlType{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlMetadataProvider)->GetXamlTypeByFullName(*(void**)(&fullName), &xamlType));
        return Windows::UI::Xaml::Markup::IXamlType{ xamlType, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IXamlMetadataProvider<D>::GetXmlnsDefinitions() const
    {
        uint32_t definitions_impl_size{};
        struct struct_Windows_UI_Xaml_Markup_XmlnsDefinition* definitions{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlMetadataProvider)->GetXmlnsDefinitions(&definitions_impl_size, &definitions));
        return com_array<Windows::UI::Xaml::Markup::XmlnsDefinition>{ definitions, definitions_impl_size, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IXamlReaderStatics<D>::Load(param::hstring const& xaml) const
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlReaderStatics)->Load(*(void**)(&xaml), &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlReaderStatics)->LoadWithInitialTemplateValidation(*(void**)(&xaml), &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlType)->ActivateInstance(&instance));
        return Windows::Foundation::IInspectable{ instance, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IXamlType<D>::CreateFromString(param::hstring const& value) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlType)->CreateFromString(*(void**)(&value), &instance));
        return Windows::Foundation::IInspectable{ instance, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Markup_IXamlType<D>::GetMember(param::hstring const& name) const
    {
        void* xamlMember{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Markup::IXamlType)->GetMember(*(void**)(&name), &xamlMember));
        return Windows::UI::Xaml::Markup::IXamlMember{ xamlMember, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall GetBindingConnector(int32_t connectionId, void* target, void** returnValue) noexcept final try
        {
    ...
    struct produce<D, Windows::UI::Xaml::Markup::IMarkupExtensionFactory> : produce_base<D, Windows::UI::Xaml::Markup::IMarkupExtensionFactory>
    {
        int32_t __stdcall CreateInstance(void* outer, void** inner, void** instance) noexcept final try
        {
            ...
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Markup::MarkupExtension>(this->shim().CreateInstance(*reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
    ...
    {
        int32_t __stdcall ProvideValue(void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Write(void* inputStreams, void* outputStreams, void* xamlMetadataProvider, struct struct_Windows_UI_Xaml_Markup_XamlBinaryWriterErrorInformation* returnValue) noexcept final try
        {
            zero_abi<Windows::UI::Xaml::Markup::XamlBinaryWriterErrorInformation>(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Xaml::Markup::IXamlBindingHelperStatics> : produce_base<D, Windows::UI::Xaml::Markup::IXamlBindingHelperStatics>
    {
        ...
        int32_t __stdcall GetDataTemplateComponent(void* element, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall ConvertValue(struct struct_Windows_UI_Xaml_Interop_TypeName type, void* value, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Xaml::Markup::IXamlMember> : produce_base<D, Windows::UI::Xaml::Markup::IXamlMember>
    {
        ...
        int32_t __stdcall GetValue(void* instance, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall GetXamlType(struct struct_Windows_UI_Xaml_Interop_TypeName type, void** xamlType) noexcept final try
        {
            clear_abi(xamlType);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetXamlTypeByFullName(void* fullName, void** xamlType) noexcept final try
        {
            clear_abi(xamlType);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetXmlnsDefinitions(uint32_t* __definitionsSize, struct struct_Windows_UI_Xaml_Markup_XmlnsDefinition** definitions) noexcept final try
        {
            clear_abi(definitions);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Load(void* xaml, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall LoadWithInitialTemplateValidation(void* xaml, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Xaml::Markup::IXamlType> : produce_base<D, Windows::UI::Xaml::Markup::IXamlType>
    {
        ...
        int32_t __stdcall CreateFromString(void* value, void** instance) noexcept final try
        {
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetMember(void* name, void** xamlMember) noexcept final try
        {
            clear_abi(xamlMember);
            typename D::abi_guard guard(this->shim());
...
namespace winrt::Windows::UI::Xaml::Markup
{
    inline MarkupExtension::MarkupExtension()
    {
        ...
        *this = impl::call_factory<MarkupExtension, Windows::UI::Xaml::Markup::IMarkupExtensionFactory>([&](auto&& f) { return f.CreateInstance(outer, inner); });
    }
