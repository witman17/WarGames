...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::IDispatcherQueueShutdownStartingEventArgs)->GetDeferral(&value));
    ...
    {
        void* deferral{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::IUserAuthenticationStatusChangingEventArgs)->GetDeferral(&deferral));
        return Windows::System::UserAuthenticationStatusChangeDeferral{ deferral, take_ownership_from_abi };
    }
    ...
    {
        void* pickSingleUserOperation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::IUserPicker)->PickSingleUserAsync(&pickSingleUserOperation));
        return Windows::Foundation::IAsyncOperation<Windows::System::User>{ pickSingleUserOperation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_IUserPickerStatics<D>::IsSupported() const
    {
        bool value;
        check_hresult(WINRT_IMPL_SHIM(Windows::System::IUserPickerStatics)->IsSupported(&value));
        return value;
    }
    template <typename D> auto consume_Windows_System_IUserStatics<D>::CreateWatcher() const
    {
        void* watcher{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::IUserStatics)->CreateWatcher(&watcher));
        return Windows::System::UserWatcher{ watcher, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::System::IUserStatics)->GetFromId(*(void**)(&nonRoamableId), &value));
        return Windows::System::User{ value, take_ownership_from_abi };
    }
    ...
    struct produce<D, Windows::System::IUserPicker> : produce_base<D, Windows::System::IUserPicker>
    {
        ...
        int32_t __stdcall PickSingleUserAsync(void** pickSingleUserOperation) noexcept final try
        {
            clear_abi(pickSingleUserOperation);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::System::IUserStatics> : produce_base<D, Windows::System::IUserStatics>
    {
        ...
        int32_t __stdcall GetFromId(void* nonRoamableId, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
