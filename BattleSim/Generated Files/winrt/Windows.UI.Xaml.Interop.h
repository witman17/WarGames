...
namespace winrt::impl
{
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::IBindableIterable)->First(&returnValue));
        return Windows::UI::Xaml::Interop::IBindableIterator{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::IBindableIterator)->MoveNext(&returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Interop_IBindableObservableVector<D>::VectorChanged(Windows::UI::Xaml::Interop::BindableVectorChangedEventHandler const& value) const
    {
        winrt::event_token token;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::IBindableObservableVector)->add_VectorChanged(*(void**)(&value), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_UI_Xaml_Interop_IBindableObservableVector<D>::VectorChanged_revoker consume_Windows_UI_Xaml_Interop_IBindableObservableVector<D>::VectorChanged(auto_revoke_t, Windows::UI::Xaml::Interop::BindableVectorChangedEventHandler const& value) const
    {
        return impl::make_event_revoker<D, VectorChanged_revoker>(this, VectorChanged(value));
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::IBindableVector)->GetAt(index, &returnValue));
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::IBindableVector)->GetView(&returnValue));
        return Windows::UI::Xaml::Interop::IBindableVectorView{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::IBindableVectorView)->GetAt(index, &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Interop_INotifyCollectionChanged<D>::CollectionChanged(Windows::UI::Xaml::Interop::NotifyCollectionChangedEventHandler const& value) const
    {
        winrt::event_token token;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::INotifyCollectionChanged)->add_CollectionChanged(*(void**)(&value), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_UI_Xaml_Interop_INotifyCollectionChanged<D>::CollectionChanged_revoker consume_Windows_UI_Xaml_Interop_INotifyCollectionChanged<D>::CollectionChanged(auto_revoke_t, Windows::UI::Xaml::Interop::NotifyCollectionChangedEventHandler const& value) const
    {
        return impl::make_event_revoker<D, CollectionChanged_revoker>(this, CollectionChanged(value));
    }
    ...
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Interop::INotifyCollectionChangedEventArgsFactory)->CreateInstanceWithAllParameters(static_cast<int32_t>(action), *(void**)(&newItems), *(void**)(&oldItems), newIndex, oldIndex, *(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Interop::NotifyCollectionChangedEventArgs{ instance, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall First(void** returnValue) noexcept final try
        {
    ...
    struct produce<D, Windows::UI::Xaml::Interop::IBindableIterator> : produce_base<D, Windows::UI::Xaml::Interop::IBindableIterator>
    {
        ...
        int32_t __stdcall MoveNext(bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall add_VectorChanged(void* value, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().VectorChanged(*reinterpret_cast<Windows::UI::Xaml::Interop::BindableVectorChangedEventHandler const*>(&value)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        int32_t __stdcall GetAt(uint32_t index, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetView(void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall add_CollectionChanged(void* value, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().CollectionChanged(*reinterpret_cast<Windows::UI::Xaml::Interop::NotifyCollectionChangedEventHandler const*>(&value)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        int32_t __stdcall CreateInstanceWithAllParameters(int32_t action, void* newItems, void* oldItems, int32_t newIndex, int32_t oldIndex, void* outer, void** inner, void** instance) noexcept final try
        {
...
namespace winrt::Windows::UI::Xaml::Interop
{
    inline NotifyCollectionChangedEventArgs::NotifyCollectionChangedEventArgs(Windows::UI::Xaml::Interop::NotifyCollectionChangedAction const& action, Windows::UI::Xaml::Interop::IBindableVector const& newItems, Windows::UI::Xaml::Interop::IBindableVector const& oldItems, int32_t newIndex, int32_t oldIndex)
    {
        ...
        *this = impl::call_factory<NotifyCollectionChangedEventArgs, Windows::UI::Xaml::Interop::INotifyCollectionChangedEventArgsFactory>([&](auto&& f) { return f.CreateInstanceWithAllParameters(action, newItems, oldItems, newIndex, oldIndex, outer, inner); });
    }
