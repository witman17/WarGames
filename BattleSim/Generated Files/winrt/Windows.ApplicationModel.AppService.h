...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::AppService::IAppServiceRequestReceivedEventArgs)->GetDeferral(&value));
        return Windows::ApplicationModel::AppService::AppServiceDeferral{ value, take_ownership_from_abi };
    }
