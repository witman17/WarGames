...
namespace winrt::impl
{
    ...
    {
        void* itemProperties{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderItemPropertySource)->GetItemProperties(*(void**)(&itemPath), &itemProperties));
        return Windows::Foundation::Collections::IIterable<Windows::Storage::Provider::StorageProviderItemProperty>{ itemProperties, take_ownership_from_abi };
    }
    ...
    {
        void* folder{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderSyncRootInfo)->get_Path(&folder));
        return Windows::Storage::IStorageFolder{ folder, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Storage_Provider_IStorageProviderSyncRootInfo<D>::Path(Windows::Storage::IStorageFolder const& folder) const
    {
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderSyncRootInfo)->put_Path(*(void**)(&folder)));
    }
    ...
    {
        void* syncRootInformation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderSyncRootManagerStatics)->GetSyncRootInformationForFolder(*(void**)(&folder), &syncRootInformation));
        return Windows::Storage::Provider::StorageProviderSyncRootInfo{ syncRootInformation, take_ownership_from_abi };
    }
    ...
    {
        void* syncRootInformation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderSyncRootManagerStatics)->GetSyncRootInformationForId(*(void**)(&id), &syncRootInformation));
        return Windows::Storage::Provider::StorageProviderSyncRootInfo{ syncRootInformation, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Storage::Provider::IStorageProviderSyncRootManagerStatics)->GetCurrentSyncRoots(&value));
        return Windows::Foundation::Collections::IVectorView<Windows::Storage::Provider::StorageProviderSyncRootInfo>{ value, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall GetItemProperties(void* itemPath, void** itemProperties) noexcept final try
        {
            clear_abi(itemProperties);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Storage::Provider::IStorageProviderSyncRootInfo> : produce_base<D, Windows::Storage::Provider::IStorageProviderSyncRootInfo>
    {
        ...
        int32_t __stdcall get_Path(void** folder) noexcept final try
        {
            clear_abi(folder);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall put_Path(void* folder) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Storage::Provider::IStorageProviderSyncRootManagerStatics> : produce_base<D, Windows::Storage::Provider::IStorageProviderSyncRootManagerStatics>
    {
        ...
        int32_t __stdcall GetSyncRootInformationForFolder(void* folder, void** syncRootInformation) noexcept final try
        {
            clear_abi(syncRootInformation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetSyncRootInformationForId(void* id, void** syncRootInformation) noexcept final try
        {
            clear_abi(syncRootInformation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetCurrentSyncRoots(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
