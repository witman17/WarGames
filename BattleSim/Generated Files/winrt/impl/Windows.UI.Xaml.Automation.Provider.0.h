...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::IDragProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetGrabbedItems(uint32_t* __returnValueSize, void***) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::IMultipleViewProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetSupportedViews(uint32_t* __returnValueSize, int32_t**) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::ISelectionProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetSelection(uint32_t* __returnValueSize, void***) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::ISpreadsheetItemProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetAnnotationObjects(uint32_t* __returnValueSize, void***) noexcept = 0;
            virtual int32_t __stdcall GetAnnotationTypes(uint32_t* __returnValueSize, int32_t**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::ITableItemProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall GetColumnHeaderItems(uint32_t* __returnValueSize, void***) noexcept = 0;
            virtual int32_t __stdcall GetRowHeaderItems(uint32_t* __returnValueSize, void***) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::ITableProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetColumnHeaders(uint32_t* __returnValueSize, void***) noexcept = 0;
            virtual int32_t __stdcall GetRowHeaders(uint32_t* __returnValueSize, void***) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::ITextProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetSelection(uint32_t* __returnValueSize, void***) noexcept = 0;
            virtual int32_t __stdcall GetVisibleRanges(uint32_t* __returnValueSize, void***) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::Xaml::Automation::Provider::ITextRangeProvider>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall GetChildren(uint32_t* __returnValueSize, void***) noexcept = 0;
        };
    };
