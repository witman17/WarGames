...
namespace winrt::impl
{
    ...
    struct consume_Windows_UI_Xaml_Printing_IPrintDocument
    {
        ...
        auto Paginate(Windows::UI::Xaml::Printing::PaginateEventHandler const& value) const;
        ...
        [[nodiscard]] Paginate_revoker Paginate(auto_revoke_t, Windows::UI::Xaml::Printing::PaginateEventHandler const& value) const;
        auto Paginate(winrt::event_token const& token) const noexcept;
        auto GetPreviewPage(Windows::UI::Xaml::Printing::GetPreviewPageEventHandler const& value) const;
        ...
        [[nodiscard]] GetPreviewPage_revoker GetPreviewPage(auto_revoke_t, Windows::UI::Xaml::Printing::GetPreviewPageEventHandler const& value) const;
        auto GetPreviewPage(winrt::event_token const& token) const noexcept;
        auto AddPages(Windows::UI::Xaml::Printing::AddPagesEventHandler const& value) const;
        ...
        [[nodiscard]] AddPages_revoker AddPages(auto_revoke_t, Windows::UI::Xaml::Printing::AddPagesEventHandler const& value) const;
