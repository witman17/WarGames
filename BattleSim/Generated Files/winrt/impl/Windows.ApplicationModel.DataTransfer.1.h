...
namespace winrt::Windows::ApplicationModel::DataTransfer
{
    ...
    struct __declspec(empty_bases) IDataPackagePropertySetView :
        ...
        impl::require<Windows::ApplicationModel::DataTransfer::IDataPackagePropertySetView, Windows::Foundation::Collections::IIterable<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::Foundation::IInspectable>>, Windows::Foundation::Collections::IMapView<hstring, Windows::Foundation::IInspectable>>
    {
