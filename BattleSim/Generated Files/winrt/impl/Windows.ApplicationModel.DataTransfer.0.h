...
namespace winrt::impl
{
    ...
    struct consume_Windows_ApplicationModel_DataTransfer_IClipboardStatics
    {
        ...
        auto Flush() const;
        auto Clear() const;
        auto ContentChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const;
        ...
        [[nodiscard]] ContentChanged_revoker ContentChanged(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const;
