...
namespace winrt::Windows::Gaming::UI
{
    ...
    struct __declspec(empty_bases) IGameMonitor :
        Windows::Foundation::IInspectable,
        impl::consume_t<IGameMonitor>
    {
        IGameMonitor(std::nullptr_t = nullptr) noexcept {}
        IGameMonitor(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    struct __declspec(empty_bases) IGameMonitorStatics :
        Windows::Foundation::IInspectable,
        impl::consume_t<IGameMonitorStatics>
    {
        IGameMonitorStatics(std::nullptr_t = nullptr) noexcept {}
        IGameMonitorStatics(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
