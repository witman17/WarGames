...
namespace winrt::Windows::Gaming::UI
{
    ...
    struct __declspec(empty_bases) GameMonitor : Windows::Gaming::UI::IGameMonitor
    {
        GameMonitor(std::nullptr_t) noexcept {}
        GameMonitor(void* ptr, take_ownership_from_abi_t) noexcept : Windows::Gaming::UI::IGameMonitor(ptr, take_ownership_from_abi) {}
        static auto GetDefault();
    };
