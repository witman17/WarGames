...
namespace winrt::Windows::ApplicationModel::DataTransfer
{
    ...
    struct Clipboard
    {
        ...
        static auto Flush();
        static auto Clear();
        static auto ContentChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler);
        ...
        [[nodiscard]] static ContentChanged_revoker ContentChanged(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler);
