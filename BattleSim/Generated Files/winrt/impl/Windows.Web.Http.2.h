...
namespace winrt::Windows::Web::Http
{
    ...
    struct __declspec(empty_bases) HttpMultipartContent : Windows::Web::Http::IHttpContent,
        impl::require<HttpMultipartContent, Windows::Foundation::Collections::IIterable<Windows::Web::Http::IHttpContent>, Windows::Web::Http::IHttpMultipartContent, Windows::Foundation::IStringable>
    {
    ...
    struct __declspec(empty_bases) HttpMultipartFormDataContent : Windows::Web::Http::IHttpContent,
        impl::require<HttpMultipartFormDataContent, Windows::Foundation::Collections::IIterable<Windows::Web::Http::IHttpContent>, Windows::Web::Http::IHttpMultipartFormDataContent, Windows::Foundation::IStringable>
    {
