...
namespace winrt::Windows::UI::Xaml::Media::Animation
{
    ...
    struct __declspec(empty_bases) SlideNavigationTransitionInfo : Windows::UI::Xaml::Media::Animation::ISlideNavigationTransitionInfo,
        ...
        impl::require<SlideNavigationTransitionInfo, Windows::UI::Xaml::Media::Animation::INavigationTransitionInfo, Windows::UI::Xaml::Media::Animation::INavigationTransitionInfoOverrides, Windows::UI::Xaml::IDependencyObject, Windows::UI::Xaml::IDependencyObject2>
    {
