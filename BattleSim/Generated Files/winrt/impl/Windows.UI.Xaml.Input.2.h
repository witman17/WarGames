...
namespace winrt::Windows::UI::Xaml::Input
{
    ...
    struct __declspec(empty_bases) AccessKeyManager : Windows::UI::Xaml::Input::IAccessKeyManager
    {
        ...
        static auto IsDisplayModeEnabledChanged(Windows::Foundation::TypedEventHandler<Windows::Foundation::IInspectable, Windows::Foundation::IInspectable> const& value);
        ...
        [[nodiscard]] static IsDisplayModeEnabledChanged_revoker IsDisplayModeEnabledChanged(auto_revoke_t, Windows::Foundation::TypedEventHandler<Windows::Foundation::IInspectable, Windows::Foundation::IInspectable> const& value);
    ...
    struct __declspec(empty_bases) GettingFocusEventArgs : Windows::UI::Xaml::Input::IGettingFocusEventArgs,
        ...
        impl::require<GettingFocusEventArgs, Windows::UI::Xaml::Input::IGettingFocusEventArgs2, Windows::UI::Xaml::IRoutedEventArgs>
    {
    ...
    struct __declspec(empty_bases) LosingFocusEventArgs : Windows::UI::Xaml::Input::ILosingFocusEventArgs,
        ...
        impl::require<LosingFocusEventArgs, Windows::UI::Xaml::Input::ILosingFocusEventArgs2, Windows::UI::Xaml::IRoutedEventArgs>
    {
