...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_IBindingBaseFactory<D>::CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IBindingBaseFactory)->CreateInstance(*(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::BindingBase{ instance, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_IBindingFactory<D>::CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IBindingFactory)->CreateInstance(*(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::Binding{ instance, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::CurrentChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& value) const
    {
        winrt::event_token token;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->add_CurrentChanged(*(void**)(&value), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_UI_Xaml_Data_ICollectionView<D>::CurrentChanged_revoker consume_Windows_UI_Xaml_Data_ICollectionView<D>::CurrentChanged(auto_revoke_t, Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& value) const
    {
        return impl::make_event_revoker<D, CurrentChanged_revoker>(this, CurrentChanged(value));
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::CurrentChanging(Windows::UI::Xaml::Data::CurrentChangingEventHandler const& value) const
    {
        winrt::event_token token;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->add_CurrentChanging(*(void**)(&value), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_UI_Xaml_Data_ICollectionView<D>::CurrentChanging_revoker consume_Windows_UI_Xaml_Data_ICollectionView<D>::CurrentChanging(auto_revoke_t, Windows::UI::Xaml::Data::CurrentChangingEventHandler const& value) const
    {
        return impl::make_event_revoker<D, CurrentChanging_revoker>(this, CurrentChanging(value));
    }
    ...
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->MoveCurrentTo(*(void**)(&item), &returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::MoveCurrentToPosition(int32_t index) const
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->MoveCurrentToPosition(index, &returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::MoveCurrentToFirst() const
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->MoveCurrentToFirst(&returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::MoveCurrentToLast() const
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->MoveCurrentToLast(&returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::MoveCurrentToNext() const
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->MoveCurrentToNext(&returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::MoveCurrentToPrevious() const
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->MoveCurrentToPrevious(&returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICollectionView<D>::LoadMoreItemsAsync(uint32_t count) const
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICollectionView)->LoadMoreItemsAsync(count, &returnValue));
        return Windows::Foundation::IAsyncOperation<Windows::UI::Xaml::Data::LoadMoreItemsResult>{ returnValue, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICurrentChangingEventArgsFactory<D>::CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICurrentChangingEventArgsFactory)->CreateInstance(*(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::CurrentChangingEventArgs{ instance, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICurrentChangingEventArgsFactory<D>::CreateWithCancelableParameter(bool isCancelable, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICurrentChangingEventArgsFactory)->CreateWithCancelableParameter(isCancelable, *(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::CurrentChangingEventArgs{ instance, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICustomProperty)->GetValue(*(void**)(&target), &returnValue));
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICustomProperty)->GetIndexedValue(*(void**)(&target), *(void**)(&index), &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICustomPropertyProvider)->GetCustomProperty(*(void**)(&name), &returnValue));
        return Windows::UI::Xaml::Data::ICustomProperty{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICustomPropertyProvider)->GetIndexedProperty(*(void**)(&name), impl::bind_in(type), &returnValue));
        return Windows::UI::Xaml::Data::ICustomProperty{ returnValue, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ICustomPropertyProvider<D>::GetStringRepresentation() const
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ICustomPropertyProvider)->GetStringRepresentation(&returnValue));
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_IItemIndexRangeFactory<D>::CreateInstance(int32_t firstIndex, uint32_t length, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IItemIndexRangeFactory)->CreateInstance(firstIndex, length, *(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::ItemIndexRange{ instance, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_INotifyPropertyChanged<D>::PropertyChanged(Windows::UI::Xaml::Data::PropertyChangedEventHandler const& value) const
    {
        winrt::event_token token;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::INotifyPropertyChanged)->add_PropertyChanged(*(void**)(&value), put_abi(token)));
        return token;
    }
    template <typename D> typename consume_Windows_UI_Xaml_Data_INotifyPropertyChanged<D>::PropertyChanged_revoker consume_Windows_UI_Xaml_Data_INotifyPropertyChanged<D>::PropertyChanged(auto_revoke_t, Windows::UI::Xaml::Data::PropertyChangedEventHandler const& value) const
    {
        return impl::make_event_revoker<D, PropertyChanged_revoker>(this, PropertyChanged(value));
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_IPropertyChangedEventArgsFactory<D>::CreateInstance(param::hstring const& name, Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IPropertyChangedEventArgsFactory)->CreateInstance(*(void**)(&name), *(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::PropertyChangedEventArgs{ instance, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_UI_Xaml_Data_IRelativeSourceFactory<D>::CreateInstance(Windows::Foundation::IInspectable const& outer, Windows::Foundation::IInspectable& inner) const
    {
        void* instance{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IRelativeSourceFactory)->CreateInstance(*(void**)(&outer), impl::bind_out(inner), &instance));
        return Windows::UI::Xaml::Data::RelativeSource{ instance, take_ownership_from_abi };
    }
    ...
    {
        bool returnValue;
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ISelectionInfo)->IsSelected(index, &returnValue));
        return returnValue;
    }
    template <typename D> auto consume_Windows_UI_Xaml_Data_ISelectionInfo<D>::GetSelectedRanges() const
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::ISelectionInfo)->GetSelectedRanges(&returnValue));
        return Windows::Foundation::Collections::IVectorView<Windows::UI::Xaml::Data::ItemIndexRange>{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IValueConverter)->Convert(*(void**)(&value), impl::bind_in(targetType), *(void**)(&parameter), *(void**)(&language), &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    {
        void* returnValue{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Xaml::Data::IValueConverter)->ConvertBack(*(void**)(&value), impl::bind_in(targetType), *(void**)(&parameter), *(void**)(&language), &returnValue));
        return Windows::Foundation::IInspectable{ returnValue, take_ownership_from_abi };
    }
    ...
    struct produce<D, Windows::UI::Xaml::Data::IBindingBaseFactory> : produce_base<D, Windows::UI::Xaml::Data::IBindingBaseFactory>
    {
        int32_t __stdcall CreateInstance(void* outer, void** inner, void** instance) noexcept final try
        {
            ...
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::BindingBase>(this->shim().CreateInstance(*reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
    ...
    struct produce<D, Windows::UI::Xaml::Data::IBindingFactory> : produce_base<D, Windows::UI::Xaml::Data::IBindingFactory>
    {
        int32_t __stdcall CreateInstance(void* outer, void** inner, void** instance) noexcept final try
        {
            ...
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::Binding>(this->shim().CreateInstance(*reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
                if (inner) *inner = detach_abi(winrt_impl_inner);
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    struct produce<D, Windows::UI::Xaml::Data::ICollectionView> : produce_base<D, Windows::UI::Xaml::Data::ICollectionView>
    {
        ...
        int32_t __stdcall add_CurrentChanged(void* value, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().CurrentChanged(*reinterpret_cast<Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const*>(&value)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        int32_t __stdcall add_CurrentChanging(void* value, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().CurrentChanging(*reinterpret_cast<Windows::UI::Xaml::Data::CurrentChangingEventHandler const*>(&value)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        int32_t __stdcall MoveCurrentTo(void* item, bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall MoveCurrentToPosition(int32_t index, bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall MoveCurrentToFirst(bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall MoveCurrentToLast(bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall MoveCurrentToNext(bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall MoveCurrentToPrevious(bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall LoadMoreItemsAsync(uint32_t count, void** returnValue) noexcept final try
        {
    ...
    struct produce<D, Windows::UI::Xaml::Data::ICurrentChangingEventArgsFactory> : produce_base<D, Windows::UI::Xaml::Data::ICurrentChangingEventArgsFactory>
    {
        int32_t __stdcall CreateInstance(void* outer, void** inner, void** instance) noexcept final try
        {
            ...
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::CurrentChangingEventArgs>(this->shim().CreateInstance(*reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
                if (inner) *inner = detach_abi(winrt_impl_inner);
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall CreateWithCancelableParameter(bool isCancelable, void* outer, void** inner, void** instance) noexcept final try
        {
            if (inner) *inner = nullptr;
            Windows::Foundation::IInspectable winrt_impl_inner;
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::CurrentChangingEventArgs>(this->shim().CreateWithCancelableParameter(isCancelable, *reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
                if (inner) *inner = detach_abi(winrt_impl_inner);
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    struct produce<D, Windows::UI::Xaml::Data::ICustomProperty> : produce_base<D, Windows::UI::Xaml::Data::ICustomProperty>
    {
        ...
        int32_t __stdcall GetValue(void* target, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetIndexedValue(void* target, void* index, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall GetCustomProperty(void* name, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetIndexedProperty(void* name, struct struct_Windows_UI_Xaml_Interop_TypeName type, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetStringRepresentation(void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall CreateInstance(int32_t firstIndex, uint32_t length, void* outer, void** inner, void** instance) noexcept final try
        {
            if (inner) *inner = nullptr;
            Windows::Foundation::IInspectable winrt_impl_inner;
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::ItemIndexRange>(this->shim().CreateInstance(firstIndex, length, *reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
                if (inner) *inner = detach_abi(winrt_impl_inner);
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        int32_t __stdcall add_PropertyChanged(void* value, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
            *token = detach_from<winrt::event_token>(this->shim().PropertyChanged(*reinterpret_cast<Windows::UI::Xaml::Data::PropertyChangedEventHandler const*>(&value)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    {
        int32_t __stdcall CreateInstance(void* name, void* outer, void** inner, void** instance) noexcept final try
        {
            if (inner) *inner = nullptr;
            Windows::Foundation::IInspectable winrt_impl_inner;
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::PropertyChangedEventArgs>(this->shim().CreateInstance(*reinterpret_cast<hstring const*>(&name), *reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
                if (inner) *inner = detach_abi(winrt_impl_inner);
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    struct produce<D, Windows::UI::Xaml::Data::IRelativeSourceFactory> : produce_base<D, Windows::UI::Xaml::Data::IRelativeSourceFactory>
    {
        int32_t __stdcall CreateInstance(void* outer, void** inner, void** instance) noexcept final try
        {
            ...
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
            *instance = detach_from<Windows::UI::Xaml::Data::RelativeSource>(this->shim().CreateInstance(*reinterpret_cast<Windows::Foundation::IInspectable const*>(&outer), winrt_impl_inner));
                if (inner) *inner = detach_abi(winrt_impl_inner);
            return 0;
        }
        catch (...) { return to_hresult(); }
    ...
    struct produce<D, Windows::UI::Xaml::Data::ISelectionInfo> : produce_base<D, Windows::UI::Xaml::Data::ISelectionInfo>
    {
        ...
        int32_t __stdcall IsSelected(int32_t index, bool* returnValue) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetSelectedRanges(void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Convert(void* value, struct struct_Windows_UI_Xaml_Interop_TypeName targetType, void* parameter, void* language, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall ConvertBack(void* value, struct struct_Windows_UI_Xaml_Interop_TypeName targetType, void* parameter, void* language, void** returnValue) noexcept final try
        {
            clear_abi(returnValue);
            typename D::abi_guard guard(this->shim());
...
namespace winrt::Windows::UI::Xaml::Data
{
    inline Binding::Binding()
    {
        ...
        *this = impl::call_factory<Binding, Windows::UI::Xaml::Data::IBindingFactory>([&](auto&& f) { return f.CreateInstance(outer, inner); });
    }
    inline BindingBase::BindingBase()
    {
        Windows::Foundation::IInspectable outer, inner;
        *this = impl::call_factory<BindingBase, Windows::UI::Xaml::Data::IBindingBaseFactory>([&](auto&& f) { return f.CreateInstance(outer, inner); });
    }
    ...
    {
        Windows::Foundation::IInspectable outer, inner;
        *this = impl::call_factory<CurrentChangingEventArgs, Windows::UI::Xaml::Data::ICurrentChangingEventArgsFactory>([&](auto&& f) { return f.CreateInstance(outer, inner); });
    }
    inline CurrentChangingEventArgs::CurrentChangingEventArgs(bool isCancelable)
    {
        Windows::Foundation::IInspectable outer, inner;
        *this = impl::call_factory<CurrentChangingEventArgs, Windows::UI::Xaml::Data::ICurrentChangingEventArgsFactory>([&](auto&& f) { return f.CreateWithCancelableParameter(isCancelable, outer, inner); });
    }
    inline ItemIndexRange::ItemIndexRange(int32_t firstIndex, uint32_t length)
    {
        Windows::Foundation::IInspectable outer, inner;
        *this = impl::call_factory<ItemIndexRange, Windows::UI::Xaml::Data::IItemIndexRangeFactory>([&](auto&& f) { return f.CreateInstance(firstIndex, length, outer, inner); });
    }
    inline PropertyChangedEventArgs::PropertyChangedEventArgs(param::hstring const& name)
    {
        Windows::Foundation::IInspectable outer, inner;
        *this = impl::call_factory<PropertyChangedEventArgs, Windows::UI::Xaml::Data::IPropertyChangedEventArgsFactory>([&](auto&& f) { return f.CreateInstance(name, outer, inner); });
    }
    inline RelativeSource::RelativeSource()
    {
        Windows::Foundation::IInspectable outer, inner;
        *this = impl::call_factory<RelativeSource, Windows::UI::Xaml::Data::IRelativeSourceFactory>([&](auto&& f) { return f.CreateInstance(outer, inner); });
    }
