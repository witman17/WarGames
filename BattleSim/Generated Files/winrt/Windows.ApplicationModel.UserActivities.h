...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::UserActivities::IUserActivityAttributionFactory)->CreateWithUri(*(void**)(&iconUri), &result));
        return Windows::ApplicationModel::UserActivities::UserActivityAttribution{ result, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::UserActivities::IUserActivityChannelStatics)->GetDefault(&value));
        return Windows::ApplicationModel::UserActivities::UserActivityChannel{ value, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::ApplicationModel::UserActivities::IUserActivityFactory)->CreateWithActivityId(*(void**)(&activityId), &result));
    ...
    {
        int32_t __stdcall CreateWithUri(void* iconUri, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall CreateWithActivityId(void* activityId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
