...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Composition_ICompositionObject4<D>::TryGetAnimationController(param::hstring const& propertyName) const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Composition::ICompositionObject4)->TryGetAnimationController(*(void**)(&propertyName), &animationController));
        return Windows::UI::Composition::AnimationController{ animationController, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall TryGetAnimationController(void* propertyName, void** animationController) noexcept final try
        {
            clear_abi(animationController);
            typename D::abi_guard guard(this->shim());
