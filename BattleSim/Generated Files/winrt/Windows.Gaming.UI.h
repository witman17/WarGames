...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Gaming_UI_IGameMonitor<D>::RequestPermissionAsync() const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::UI::IGameMonitor)->RequestPermissionAsync(&operation));
        return Windows::Foundation::IAsyncOperation<Windows::Gaming::UI::GameMonitoringPermission>{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Gaming_UI_IGameMonitorStatics<D>::GetDefault() const
    {
        void* gameMonitor{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Gaming::UI::IGameMonitorStatics)->GetDefault(&gameMonitor));
        return Windows::Gaming::UI::GameMonitor{ gameMonitor, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall RequestPermissionAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<Windows::Foundation::IAsyncOperation<Windows::Gaming::UI::GameMonitoringPermission>>(this->shim().RequestPermissionAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    {
        int32_t __stdcall GetDefault(void** gameMonitor) noexcept final try
        {
            clear_abi(gameMonitor);
            typename D::abi_guard guard(this->shim());
            *gameMonitor = detach_from<Windows::Gaming::UI::GameMonitor>(this->shim().GetDefault());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
namespace winrt::Windows::Gaming::UI
{
    ...
    inline auto GameMonitor::GetDefault()
    {
        return impl::call_factory<GameMonitor, Windows::Gaming::UI::IGameMonitorStatics>([&](auto&& f) { return f.GetDefault(); });
    }
}
namespace std
{
    ...
    template<> struct hash<winrt::Windows::Gaming::UI::IGameMonitor> : winrt::impl::hash_base {};
    template<> struct hash<winrt::Windows::Gaming::UI::IGameMonitorStatics> : winrt::impl::hash_base {};
    ...
    template<> struct hash<winrt::Windows::Gaming::UI::GameMonitor> : winrt::impl::hash_base {};
