...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Notifications::Management::IUserNotificationListener)->RequestAccessAsync(&result));
        return Windows::Foundation::IAsyncOperation<Windows::UI::Notifications::Management::UserNotificationListenerAccessStatus>{ result, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_UI_Notifications_Management_IUserNotificationListener<D>::GetAccessStatus() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Notifications::Management::IUserNotificationListener)->GetAccessStatus(put_abi(accessStatus)));
        return accessStatus;
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Notifications::Management::IUserNotificationListener)->GetNotificationsAsync(static_cast<uint32_t>(kinds), &result));
        return Windows::Foundation::IAsyncOperation<Windows::Foundation::Collections::IVectorView<Windows::UI::Notifications::UserNotification>>{ result, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(Windows::UI::Notifications::Management::IUserNotificationListenerStatics)->get_Current(&result));
        return Windows::UI::Notifications::Management::UserNotificationListener{ result, take_ownership_from_abi };
    }
    template <typename D>
    struct produce<D, Windows::UI::Notifications::Management::IUserNotificationListener> : produce_base<D, Windows::UI::Notifications::Management::IUserNotificationListener>
    {
        ...
        int32_t __stdcall GetAccessStatus(int32_t* accessStatus) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetNotificationsAsync(uint32_t kinds, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall get_Current(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
