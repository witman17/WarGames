...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Networking::PushNotifications::IPushNotificationChannelManagerStatics3)->GetDefault(&value));
        return Windows::Networking::PushNotifications::PushNotificationChannelManagerForUser{ value, take_ownership_from_abi };
    }
