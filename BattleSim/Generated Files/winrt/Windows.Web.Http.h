...
namespace winrt::impl
{
    ...
    {
        void* bufferContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpBufferContentFactory)->CreateFromBuffer(*(void**)(&content), &bufferContent));
        return Windows::Web::Http::HttpBufferContent{ bufferContent, take_ownership_from_abi };
    }
    ...
    {
        void* bufferContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpBufferContentFactory)->CreateFromBufferWithOffset(*(void**)(&content), offset, count, &bufferContent));
        return Windows::Web::Http::HttpBufferContent{ bufferContent, take_ownership_from_abi };
    }
    ...
    {
        void* client{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpClientFactory)->Create(*(void**)(&filter), &client));
        return Windows::Web::Http::HttpClient{ client, take_ownership_from_abi };
    }
    ...
    {
        void* cookie{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpCookieFactory)->Create(*(void**)(&name), *(void**)(&domain), *(void**)(&path), &cookie));
        return Windows::Web::Http::HttpCookie{ cookie, take_ownership_from_abi };
    }
    ...
    {
        bool replaced;
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpCookieManager)->SetCookie(*(void**)(&cookie), &replaced));
        return replaced;
    }
    ...
    {
        bool replaced;
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpCookieManager)->SetCookieWithThirdParty(*(void**)(&cookie), thirdParty, &replaced));
        return replaced;
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpCookieManager)->GetCookies(*(void**)(&uri), &value));
        return Windows::Web::Http::HttpCookieCollection{ value, take_ownership_from_abi };
    }
    ...
    {
        void* formUrlEncodedContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpFormUrlEncodedContentFactory)->Create(*(void**)(&content), &formUrlEncodedContent));
        return Windows::Web::Http::HttpFormUrlEncodedContent{ formUrlEncodedContent, take_ownership_from_abi };
    }
    ...
    {
        void* httpMethod{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpMethodFactory)->Create(*(void**)(&method), &httpMethod));
        return Windows::Web::Http::HttpMethod{ httpMethod, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_Web_Http_IHttpMultipartContentFactory<D>::CreateWithSubtype(param::hstring const& subtype) const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpMultipartContentFactory)->CreateWithSubtype(*(void**)(&subtype), &multipartContent));
        return Windows::Web::Http::HttpMultipartContent{ multipartContent, take_ownership_from_abi };
    }
    ...
    {
        void* multipartContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpMultipartContentFactory)->CreateWithSubtypeAndBoundary(*(void**)(&subtype), *(void**)(&boundary), &multipartContent));
        return Windows::Web::Http::HttpMultipartContent{ multipartContent, take_ownership_from_abi };
    }
    ...
    {
        void* multipartFormDataContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpMultipartFormDataContentFactory)->CreateWithBoundary(*(void**)(&boundary), &multipartFormDataContent));
        return Windows::Web::Http::HttpMultipartFormDataContent{ multipartFormDataContent, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_Web_Http_IHttpRequestMessageFactory<D>::Create(Windows::Web::Http::HttpMethod const& method, Windows::Foundation::Uri const& uri) const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpRequestMessageFactory)->Create(*(void**)(&method), *(void**)(&uri), &httpRequestMessage));
        return Windows::Web::Http::HttpRequestMessage{ httpRequestMessage, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_Web_Http_IHttpResponseMessage<D>::EnsureSuccessStatusCode() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpResponseMessage)->EnsureSuccessStatusCode(&httpResponseMessage));
        return Windows::Web::Http::HttpResponseMessage{ httpResponseMessage, take_ownership_from_abi };
    }
    ...
    {
        void* httpResponseMessage{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpResponseMessageFactory)->Create(static_cast<int32_t>(statusCode), &httpResponseMessage));
        return Windows::Web::Http::HttpResponseMessage{ httpResponseMessage, take_ownership_from_abi };
    }
    ...
    {
        void* streamContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpStreamContentFactory)->CreateFromInputStream(*(void**)(&content), &streamContent));
        return Windows::Web::Http::HttpStreamContent{ streamContent, take_ownership_from_abi };
    }
    ...
    {
        void* stringContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpStringContentFactory)->CreateFromString(*(void**)(&content), &stringContent));
        return Windows::Web::Http::HttpStringContent{ stringContent, take_ownership_from_abi };
    }
    ...
    {
        void* stringContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpStringContentFactory)->CreateFromStringWithEncoding(*(void**)(&content), static_cast<int32_t>(encoding), &stringContent));
        return Windows::Web::Http::HttpStringContent{ stringContent, take_ownership_from_abi };
    }
    ...
    {
        void* stringContent{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Web::Http::IHttpStringContentFactory)->CreateFromStringWithEncodingAndMediaType(*(void**)(&content), static_cast<int32_t>(encoding), *(void**)(&mediaType), &stringContent));
        return Windows::Web::Http::HttpStringContent{ stringContent, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall CreateFromBuffer(void* content, void** bufferContent) noexcept final try
        {
            clear_abi(bufferContent);
        ...
        int32_t __stdcall CreateFromBufferWithOffset(void* content, uint32_t offset, uint32_t count, void** bufferContent) noexcept final try
        {
            clear_abi(bufferContent);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Create(void* filter, void** client) noexcept final try
        {
            clear_abi(client);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Create(void* name, void* domain, void* path, void** cookie) noexcept final try
        {
            clear_abi(cookie);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall SetCookie(void* cookie, bool* replaced) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall SetCookieWithThirdParty(void* cookie, bool thirdParty, bool* replaced) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall GetCookies(void* uri, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Create(void* content, void** formUrlEncodedContent) noexcept final try
        {
            clear_abi(formUrlEncodedContent);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Create(void* method, void** httpMethod) noexcept final try
        {
            clear_abi(httpMethod);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall CreateWithSubtype(void* subtype, void** multipartContent) noexcept final try
        {
            clear_abi(multipartContent);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall CreateWithSubtypeAndBoundary(void* subtype, void* boundary, void** multipartContent) noexcept final try
        {
            clear_abi(multipartContent);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall CreateWithBoundary(void* boundary, void** multipartFormDataContent) noexcept final try
        {
            clear_abi(multipartFormDataContent);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Create(void* method, void* uri, void** httpRequestMessage) noexcept final try
        {
            clear_abi(httpRequestMessage);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Web::Http::IHttpResponseMessage> : produce_base<D, Windows::Web::Http::IHttpResponseMessage>
    {
        ...
        int32_t __stdcall EnsureSuccessStatusCode(void** httpResponseMessage) noexcept final try
        {
            clear_abi(httpResponseMessage);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall Create(int32_t statusCode, void** httpResponseMessage) noexcept final try
        {
            clear_abi(httpResponseMessage);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall CreateFromInputStream(void* content, void** streamContent) noexcept final try
        {
            clear_abi(streamContent);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall CreateFromString(void* content, void** stringContent) noexcept final try
        {
            clear_abi(stringContent);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall CreateFromStringWithEncoding(void* content, int32_t encoding, void** stringContent) noexcept final try
        {
            clear_abi(stringContent);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t __stdcall CreateFromStringWithEncodingAndMediaType(void* content, int32_t encoding, void* mediaType, void** stringContent) noexcept final try
        {
            clear_abi(stringContent);
            typename D::abi_guard guard(this->shim());
