...
namespace winrt::impl
{
    ...
    {
        void* preview{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::PointOfService::IBarcodeScannerImagePreviewReceivedEventArgs)->get_Preview(&preview));
        return Windows::Storage::Streams::IRandomAccessStreamWithContentType{ preview, take_ownership_from_abi };
    }
    ...
    {
        void* drawer{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::PointOfService::ICashDrawerEventSourceEventArgs)->get_CashDrawer(&drawer));
        return Windows::Devices::PointOfService::CashDrawer{ drawer, take_ownership_from_abi };
    }
    ...
    {
        void* escapeSequence{};
        check_hresult(WINRT_IMPL_SHIM(Windows::Devices::PointOfService::ILineDisplayStoredBitmap)->get_EscapeSequence(&escapeSequence));
        return hstring{ escapeSequence, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall get_Preview(void** preview) noexcept final try
        {
            clear_abi(preview);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall get_CashDrawer(void** drawer) noexcept final try
        {
            clear_abi(drawer);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall get_EscapeSequence(void** escapeSequence) noexcept final try
        {
            clear_abi(escapeSequence);
            typename D::abi_guard guard(this->shim());
