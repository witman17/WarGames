...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"WarGames.MainPage"))
    {
        return winrt_make_WarGames_MainPage();
    }

    if (requal(name, L"WarGames.XamlMetaDataProvider"))
    {
        return winrt_make_WarGames_XamlMetaDataProvider();
    }
